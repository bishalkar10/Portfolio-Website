...
export const Card: React.FC<CardProps> = ({ index, imgPath, githubURL, demoURL, name, description }) => {
    ...
    >  {/* if items is even then flex-direction : row-reverse  */}
      <div className="card-div">
        <figure className="figure ">
          ...
          <img className="image" src={imgPath} alt={name}
        ...
        <div className=" button-container ">
          <a className="demo-btn" href={demoURL} target="_blank">Demo</a>
          <a className="code-btn" href={githubURL} target="_blank">Code</a>
        </div>
      </div>
